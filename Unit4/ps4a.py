...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while max(hand.values()) > 0: # As long as there are still letters left in the hand:
    ...
    if user_end == True:
        print(f"Goodbye! Total score: {score} points.")  # Game is over (user entered a '.' or ran out of letters), so tell user the total score
    else:
